...
public class CopperGen implements IWorldGenerator {
	...
	public void generateNether(World world, Random rand, int x, int z) {
		generateOre(Testmod.blockCopper, world, rand, x, z, 2, 10, 7, 0, 100, Blocks.netherrack);
	}

	public void generateOverworld(World world, Random rand, int x, int z) {
		generateOre(Testmod.blockCopper, world, rand, x, z, 2, 10, 7, 0, 100, Blocks.stone);
	}

	public void generateEnd(World world, Random rand, int x, int z) {
		generateOre(Testmod.blockCopper, world, rand, x, z, 2, 10, 7, 0, 100, Blocks.end_stone);
	}
